    ...
    return (
        <>
            ...
            <Button className=" relative group/imageTool" {...rest}>
                ...
                {/* show button name, except on small screens */}
                <span className='hidden md:inline-block opacity-0 text-xs p-1 absolute -right-20 transition duration-300 ease-in-out group-hover/imageTool:opacity-100 z-10 bg-neutral-200 dark:bg-neutral-800 rounded'>Add Image</span>
            </Button>
        </>
    )
}
    ...
    return (
        <>
            ...
            <Button className="relative group/codeTool">
                ...
                {/* show button name, except on small screens */}
                <span className='hidden md:inline-block opacity-0 text-xs p-1 absolute -bottom-12 md:-right-20 transition duration-300 ease-in-out group-hover/codeTool:opacity-100 z-10 bg-neutral-200 dark:bg-neutral-800 rounded'>Add Code</span>
            </Button>
        </>
    )
}
